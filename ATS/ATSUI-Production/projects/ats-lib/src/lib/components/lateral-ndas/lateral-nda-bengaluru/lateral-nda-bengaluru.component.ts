...
@Component({
  selector: 'lib-lateral-nda-bengaluru',
  templateUrl: './lateral-nda-bengaluru.component.html',
  styleUrls: ['./lateral-nda-bengaluru.component.scss']
})
export class LateralNdaBengaluru implements OnInit,OnChanges {
  public ndaLateralForm: UntypedFormGroup = new UntypedFormGroup({});
  public formId:number = 45;
