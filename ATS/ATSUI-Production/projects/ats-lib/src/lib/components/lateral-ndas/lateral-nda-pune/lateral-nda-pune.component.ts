...
@Component({
  selector: 'lib-lateral-nda-pune',
  templateUrl: './lateral-nda-pune.component.html',
  styleUrls: ['./lateral-nda-pune.component.scss']
})
export class LateralNdaPune implements OnInit,OnChanges {
  public ndaLateralForm: UntypedFormGroup = new UntypedFormGroup({});
  public formId:number = 41;
