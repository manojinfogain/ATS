...
@Component({
  selector: 'lib-lateral-nda-mumbai',
  templateUrl: './lateral-nda-mumbai.component.html',
  styleUrls: ['./lateral-nda-mumbai.component.scss']
})
export class LateralNdaMumbai implements OnInit,OnChanges {
  public ndaLateralForm: UntypedFormGroup = new UntypedFormGroup({});
  public formId:number = 44;
