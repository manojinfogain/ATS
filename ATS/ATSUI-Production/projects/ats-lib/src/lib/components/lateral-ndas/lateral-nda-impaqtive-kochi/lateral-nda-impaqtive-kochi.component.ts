...
@Component({
  selector: 'lib-lateral-nda-impaqtive-kochi',
  templateUrl: './lateral-nda-impaqtive-kochi.component.html',
  styleUrls: ['./lateral-nda-impaqtive-kochi.component.scss']
})
export class LateralNdaImpaqtiveKochiComponent implements OnInit {
 public ndaLateralForm: UntypedFormGroup = new UntypedFormGroup({});
  public formId:number = 18;
