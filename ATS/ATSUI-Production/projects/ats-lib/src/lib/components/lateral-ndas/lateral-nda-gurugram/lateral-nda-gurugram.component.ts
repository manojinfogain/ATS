...
@Component({
  selector: 'lib-lateral-nda-gurugram',
  templateUrl: './lateral-nda-gurugram.component.html',
  styleUrls: ['./lateral-nda-gurugram.component.scss']
})
export class LateralNdaGurugram implements OnInit,OnChanges {
  public ndaLateralForm: UntypedFormGroup = new UntypedFormGroup({});
  public formId:number = 43;
