...
@Component({
  selector: 'lib-trainees-dcthird-party-contractual-nda',
  templateUrl: './trainees-dcthird-party-contractual-nda.component.html',
  styleUrls: ['./trainees-dcthird-party-contractual-nda.component.scss']
})
export class TraineesDCThirdPartyContractualNDAComponent implements OnInit,OnChanges {
