...
@Component({
  selector: 'lib-posh-doc-banglore',
  templateUrl: './posh-doc-banglore.component.html',
  styleUrls: ['./posh-doc-banglore.component.scss']
})
export class PoshDocBangloreComponent implements OnInit {
