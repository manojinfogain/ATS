...
@Component({
  selector: 'lib-other-nda-gurugram',
  templateUrl: './other-nda-gurugram.component.html',
  styleUrls: ['./other-nda-gurugram.component.scss']
})
export class OtherNdaGurugramComponent implements OnInit,OnChanges {
  public otherNDAForm: UntypedFormGroup = new UntypedFormGroup({});
  public formId:number = 39;
