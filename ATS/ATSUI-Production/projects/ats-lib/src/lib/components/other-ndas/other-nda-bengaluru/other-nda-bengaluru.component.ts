...
@Component({
  selector: 'lib-other-nda-bengaluru',
  templateUrl: './other-nda-bengaluru.component.html',
  styleUrls: ['./other-nda-bengaluru.component.scss']
})
export class OtherNdaBengaluruComponent implements OnInit,OnChanges {
  public otherNDAForm: UntypedFormGroup = new UntypedFormGroup({});
  public formId:number = 40;
