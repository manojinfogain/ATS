...
@Component({
  selector: 'lib-other-nda-noida',
  templateUrl: './other-nda-noida.component.html',
  styleUrls: ['./other-nda-noida.component.scss']
})
export class OtherNdaNoidaComponent implements OnInit,OnChanges {
  public otherNDAForm: UntypedFormGroup = new UntypedFormGroup({});
  public formId:number = 37;
