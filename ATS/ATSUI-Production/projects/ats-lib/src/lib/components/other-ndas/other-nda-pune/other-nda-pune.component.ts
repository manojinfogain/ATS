...
@Component({
  selector: 'lib-other-nda-pune',
  templateUrl: './other-nda-pune.component.html',
  styleUrls: ['./other-nda-pune.component.scss']
})
export class OtherNdaPuneComponent implements OnInit,OnChanges {
  public otherNDAForm: UntypedFormGroup = new UntypedFormGroup({});
  public formId:number = 36;
