...
import { LIBsalaryMinMaxLoc } from '../../../core/constant/lib-common.const';
...
import { LibGetSetStorageService } from '../../../services/lib-get-set-storage.service';
import { LibGlobalCommonMethodService } from '../../../services/lib-global-common-method.service';


@Component({
  selector: 'lib-salary-details',
  templateUrl: './lib-salary-details.component.html',
  styleUrls: ['./lib-salary-details.component.scss']
})
export class LibSalaryDetailsComponent implements OnInit {
  ...
  public salRange: any = LIBsalaryMinMaxLoc;
  ...
  constructor(
    ...
    public _storage: LibGetSetStorageService,
    public _globalMethod: LibGlobalCommonMethodService
  ) { }
  ...
  ngOnInit(): void {
    ...
    //   }
    // )
    this._candidateServe.getCandidateSalaryDetails(this.apiBaseUrlCand).subscribe(
      res => {
  ...
  getCurrencyList() {
    this._exGlobal.GetCurrencyList(this.apiBaseUrlMaster).subscribe(
      res => {
