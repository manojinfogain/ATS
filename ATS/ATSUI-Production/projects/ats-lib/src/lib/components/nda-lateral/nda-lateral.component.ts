...
@Component({
  selector: 'lib-nda-lateral',
  templateUrl: './nda-lateral.component.html',
  styleUrls: ['./nda-lateral.component.scss']
})
export class NDALateralComponent implements OnInit,OnChanges {
