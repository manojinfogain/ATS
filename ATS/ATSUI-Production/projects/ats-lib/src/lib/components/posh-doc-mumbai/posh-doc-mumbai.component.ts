...
@Component({
  selector: 'lib-posh-doc-mumbai',
  templateUrl: './posh-doc-mumbai.component.html',
  styleUrls: ['./posh-doc-mumbai.component.scss']
})
export class PoshDocMumbaiComponent implements OnInit,OnChanges {
  public formId:number = 21;
