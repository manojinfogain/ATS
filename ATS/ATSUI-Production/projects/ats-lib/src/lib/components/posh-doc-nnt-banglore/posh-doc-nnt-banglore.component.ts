...
@Component({
  selector: 'lib-posh-doc-nnt-banglore',
  templateUrl: './posh-doc-nnt-banglore.component.html',
  styleUrls: ['./posh-doc-nnt-banglore.component.scss']
})
export class PoshDocNntBangloreComponent implements OnInit {
  public formId:number = 31;
  public pageTotal:number = 7;
  public rightTextHeader:string = '';
  public leftText:string = 'ISMS/PL-HR-63/Version 12.0 <br>Jan 01, 2025';
