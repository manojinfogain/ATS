...
@Component({
  selector: 'lib-posh-doc-impaqtive-kochi',
  templateUrl: './posh-doc-impaqtive-kochi.component.html',
  styleUrls: ['./posh-doc-impaqtive-kochi.component.scss']
})
export class PoshDocImpaqtiveKochiComponent implements OnInit {

  public formId:number = 20;
   public pageTotal:number = 7;
   public rightTextHeader:string = '';
  //  public leftText:string = 'ISMS/PL-HR-64/Version 13.0 <br>Dec 01, 2025';
