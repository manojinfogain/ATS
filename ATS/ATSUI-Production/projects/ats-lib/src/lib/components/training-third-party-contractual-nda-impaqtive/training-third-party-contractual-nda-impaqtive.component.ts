...
@Component({
  selector: 'lib-training-third-party-contractual-nda-impaqtive',
  templateUrl: './training-third-party-contractual-nda-impaqtive.component.html',
  styleUrls: ['./training-third-party-contractual-nda-impaqtive.component.scss']
})
export class TrainingThirdPartyContractualNdaImpaqtiveComponent implements OnInit {

    public otherNDAForm: UntypedFormGroup = new UntypedFormGroup({});
    public formId:number = 25;
