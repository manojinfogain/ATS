...
@Component({
  selector: 'lib-conflictof-interes-policy',
  templateUrl: './conflictof-interes-policy.component.html',
  styleUrls: ['./conflictof-interes-policy.component.scss']
})
export class ConflictofInteresPolicyComponent implements OnInit,OnChanges {
  public formId:number = 16;
  public pageTotal:number = 6;
  ...
  signFinal(element: any = {}): void {
    if(this.result?.bodySign){
      this.CandidateSignatureModel.page6=this.result?.signImage;
    }
  }
