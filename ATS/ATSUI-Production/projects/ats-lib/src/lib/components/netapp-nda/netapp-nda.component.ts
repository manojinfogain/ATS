...
@Component({
  selector: 'lib-netapp-nda',
  templateUrl: './netapp-nda.component.html',
  styleUrls: ['./netapp-nda.component.scss']
})
export class NetappNdaComponent implements OnInit,OnChanges {
