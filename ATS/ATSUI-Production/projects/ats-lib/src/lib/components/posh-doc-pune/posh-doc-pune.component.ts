...
@Component({
  selector: 'lib-posh-doc-pune',
  templateUrl: './posh-doc-pune.component.html',
  styleUrls: ['./posh-doc-pune.component.scss']
})
export class PoshDocPuneComponent implements OnInit,OnChanges {
  public formId:number = 22;
