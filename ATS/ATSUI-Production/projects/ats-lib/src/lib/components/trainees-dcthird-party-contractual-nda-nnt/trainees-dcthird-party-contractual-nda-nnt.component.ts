...
@Component({
  selector: 'lib-trainees-dcthird-party-contractual-nda-nnt',
  templateUrl: './trainees-dcthird-party-contractual-nda-nnt.component.html',
  styleUrls: ['./trainees-dcthird-party-contractual-nda-nnt.component.scss']
})
export class TraineesDCThirdPartyContractualNDANNTComponent implements OnInit,OnChanges {
  public traineesDCTNDAFormNNT: UntypedFormGroup = new UntypedFormGroup({});
  public formId:number = 24;
  ...
  constructor(
     ...
     */
     formInit() {
      this.traineesDCTNDAFormNNT = this._fb.group({
