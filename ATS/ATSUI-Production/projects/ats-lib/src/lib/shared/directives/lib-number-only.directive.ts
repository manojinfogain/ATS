...
export class LibNumberOnlyDirective {
...
@Directive({
  selector: "[libOnlyDecimalNumber]"
})
export class LibNumberDecimalDirective {
...
@Directive({
  selector: "[libMobNumber]"
})
export class LibmobileNumberDirective {
  constructor(private _el: NgControl) { }
...
@Directive({
  selector: "[libGradeValueDecimalNumber]"
})
export class LibGradeValueDecimalDirective {
...
@Directive({
  selector: "[libPrevInitZeroSingleAllowed]"
})
export class LibPrevInitZeroSingleAllowedDirective {
  // Allow key codes for special events. Reflect :
  // Backspace, tab, end, home
  private specialKeys: Array<string> = [
    "Backspace",
