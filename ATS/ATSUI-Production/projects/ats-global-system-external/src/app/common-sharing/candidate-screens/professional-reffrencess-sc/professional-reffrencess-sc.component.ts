...
import { CandidateProfessionalReferenceFormModalComponent } from '../other-details-sc/Modal/candidate-pro-ref-form-modal/candidate-pro-ref-form-modal.component';
...
@Component({
  selector: 'app-professional-reffrencess-sc',
  templateUrl: './professional-reffrencess-sc.component.html',
  styleUrls: ['./professional-reffrencess-sc.component.scss']
})
export class ProfessionalReffrencessScComponent implements OnInit {
  ...
  //   return this.otherDetailsform.get('Questionire') as FormArray;
  // }
  get ReferencesGroup() {
