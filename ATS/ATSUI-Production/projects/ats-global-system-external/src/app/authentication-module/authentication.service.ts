...
import { SERVICE_CONST } from 'projects/ats-global-system-external/src/app/core/constant/service.const';
...
import { SkipError } from 'projects/ats-global-system-external/src/app/core/interceptors/http-error.interceptor';
@Injectable({
  providedIn: 'root'
})
