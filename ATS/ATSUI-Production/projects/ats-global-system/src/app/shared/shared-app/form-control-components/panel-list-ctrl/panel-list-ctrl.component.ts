...
@Component({
  selector: 'app-panel-list-ctrl',
  templateUrl: './panel-list-ctrl.component.html',
  styleUrls: ['./panel-list-ctrl.component.scss']
})
export class PanelListCtrlComponent implements OnInit {
