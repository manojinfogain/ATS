...
@Component({
  selector: 'app-talent-additional-skill-control',
  templateUrl: './talent-additional-skill-control.component.html',
  styleUrls: ['./talent-additional-skill-control.component.scss']
})
export class TalentAdditionalSkillControlComponent implements OnInit, AfterViewInit {
  ...
  @Input() public isDisabledForEdit:boolean = false;
