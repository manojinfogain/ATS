...
@Component({
  selector: 'app-account-owner-control',
  templateUrl: './account-owner-control.component.html',
  styleUrls: ['./account-owner-control.component.scss']
})
export class AccountOwnerControlComponent implements OnInit {
  @Input() public parentIdControl: UntypedFormControl;
  public FilterCtrl: UntypedFormControl = new UntypedFormControl();
  public searchInput: string;
  public HMList:any = [];
  @Input() placeholder:string = 'Search';
  @Input() title:string = 'Account Head';
  ...
  getHMList() {
    this._globalApi.getAllAccountHeadList().subscribe(
      res => {
