...
@Component({
  selector: 'app-bizops-control',
  templateUrl: './bizops-control.component.html',
  styleUrls: ['./bizops-control.component.scss']
})
export class BizopsControlComponent implements OnInit {
   ...
   @Input() public IdControl: UntypedFormControl;
    ...
    @Input() title:string = 'BizOps Lead';
    ...
    ngOnChanges(): void {
      ...
      */
       getBizOpsList():void{
        this._intCommonServe.getBizOpsList().subscribe(
          res => {
