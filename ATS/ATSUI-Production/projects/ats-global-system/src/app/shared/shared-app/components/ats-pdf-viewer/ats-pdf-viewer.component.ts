...
@Component({
  selector: 'app-ats-pdf-viewer',
  templateUrl: './ats-pdf-viewer.component.html',
  styleUrls: ['./ats-pdf-viewer.component.scss']
})
export class AtsPdfViewerComponent  implements OnChanges, OnDestroy {
