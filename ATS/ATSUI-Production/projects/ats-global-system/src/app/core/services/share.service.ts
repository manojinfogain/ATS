...
export class ShareService {
  ...
  public showAlertErrorParamMessage = new Subject<any>();
  ...
  public detectExcelExportPMWise = new Subject<any>();
  public detectExcelExportHiringManagerWise = new Subject<any>();
}
