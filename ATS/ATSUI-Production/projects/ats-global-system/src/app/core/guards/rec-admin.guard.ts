...
export class RecAdminGuard implements CanActivate {
  ...
  canActivate(
    ...
    if (this._authServe.isRecruiterAdmin() === true  || this._authServe.isRecruiter() === true || this._authServe.isSuperAdmin() === true|| this._authServe.isAdminRenuTeam() === true){  
      return true;
    }
    else{
