...
export class RecRecAdminSuperadminApproverGuard  {
  ...
  canActivate(
    ...
    state: RouterStateSnapshot): Observable<boolean | UrlTree> | Promise<boolean | UrlTree> | boolean | UrlTree {
      if (this._authServe.isRecruiterAdmin() === true  || this._authServe.isRecruiter() === true || this._authServe.isSuperAdmin() === true || this._authServe.isAdminRenuTeam() === true || this._authServe.isApproverLogin() === true){  
        return true
      }
      else{
