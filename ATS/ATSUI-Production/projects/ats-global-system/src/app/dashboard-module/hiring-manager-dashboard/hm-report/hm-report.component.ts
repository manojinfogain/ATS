...
@Component({
  selector: 'app-hm-report',
  templateUrl: './hm-report.component.html',
  styleUrls: ['./hm-report.component.scss']
})
export class HmReportComponent implements OnInit,OnChanges {
