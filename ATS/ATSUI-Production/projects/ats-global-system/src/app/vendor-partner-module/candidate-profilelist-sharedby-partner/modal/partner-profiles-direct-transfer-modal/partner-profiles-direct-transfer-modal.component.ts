...
@Component({
  selector: 'app-partner-profiles-direct-transfer-modal',
  templateUrl: './partner-profiles-direct-transfer-modal.component.html',
  styleUrls: ['./partner-profiles-direct-transfer-modal.component.scss']
})
export class PartnerProfilesDirectTransferModalComponent implements OnInit {
  public userData: any = {};
  ...
  constructor(
    public dialogRef: MatDialogRef<PartnerProfilesDirectTransferModalComponent>,
  ...
  TransferTalent(form: any) {
    if (this.formTransfer.valid) {
      ...
      if (this.data['type'] === 1) {
        ...
        if(formValue['telentId']){
          formValue['toThId'] = formValue['telentId'];
        }
        if(formValue['remarksTransfer']){
          formValue['remarks'] = formValue['remarksTransfer'];
        }
        delete formValue['remarksTransfer'];
        delete formValue['telentId'];
