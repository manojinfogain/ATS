...
@Component({
  selector: 'app-manual-offer-gen-screen-modal',
  templateUrl: './manual-offer-gen-screen-modal.component.html',
  styleUrls: ['./manual-offer-gen-screen-modal.component.scss']
})
export class ManualOfferGenScreenModalComponent implements OnInit {
  ...
  constructor(
    public dialogRef: MatDialogRef<ManualOfferGenScreenModalComponent>,
 ...
 */
  ...
  uploadOfferletter(formData:FormData){
    ...
    this._offerServiceG5.uploadOffer(formData).subscribe(
      res => {
        this._share.showAlertSuccessMessage.next(res)
