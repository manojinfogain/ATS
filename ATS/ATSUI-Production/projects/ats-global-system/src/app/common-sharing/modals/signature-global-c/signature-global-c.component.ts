...
@Component({
  selector: 'app-signature-global-c',
  templateUrl: './signature-global-c.component.html',
  styleUrls: ['./signature-global-c.component.scss']
})
export class SignatureGlobalCComponent implements OnInit {
  signPad: any;
  ...
  signImage:any;
  constructor(
    public dialogRef: MatDialogRef<SignatureGlobalCComponent>,
  ...
  saveSignPad() {
   ...
   // this.setGetImage(this.signImage);
    let signData = {
      ...
      signFileName: `signature_${this.nameDate}.png` 
    }
    let sendData = {
      signImageHR: this.signImage,
      signFileName: signData.signFileName,
     // signFilePath: signData.signFilePath
    }        
