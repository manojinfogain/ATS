...
@Component({
  selector: 'app-us-otp-verification-modal',
  templateUrl: './us-otp-verification-modal.component.html',
  styleUrls: ['./us-otp-verification-modal.component.scss']
})
export class UsOtpVerificationModalComponent implements OnInit {
  ...
  constructor(
    public dialogRef: MatDialogRef<UsOtpVerificationModalComponent>,
 ...
 */
  ...
  submitOtpForm(form: UntypedFormGroup) {
    ...
    if (form.valid) {
      ...
      this._candServe.CandidateSubmitOtpUS(param).subscribe(
        res => {
