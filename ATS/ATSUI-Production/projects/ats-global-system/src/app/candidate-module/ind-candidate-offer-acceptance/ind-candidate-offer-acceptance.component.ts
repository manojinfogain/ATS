...
@Component({
  selector: 'app-ind-candidate-offer-acceptance',
  templateUrl: './ind-candidate-offer-acceptance.component.html',
  styleUrls: ['./ind-candidate-offer-acceptance.component.scss']
})
export class IndCandidateOfferAcceptanceComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    // const dialogRef = this._dialog.open(ManualOfferAcceptIndModalComponent, {
    ...
    // this.paramCid = queryParamCid;
   // this.viewAcceptOfferModal({key:this.paramCid})
  ...
  /**authe candidate while getting data */
  ...
  openOtpModal(elm: any) {
    ...
    const dialogRef = this._dialog.open(IndOtpVerificationModalComponent, {
  ...
  submitForm(form: UntypedFormGroup) {
    ...
    this.submit = true;
      if (form.valid) {
        ...
        formData['candidateDetails'] = this.candidateDetails;
